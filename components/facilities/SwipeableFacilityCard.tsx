...
import { MapPin, Star, Baby, Heart } from 'lucide-react';
    ...
    <div className="relative overflow-hidden">
      ...
      >
        <Link href={`/facilities/${facility.id}`}>
          <Card className="h-full hover:shadow-2xl hover:scale-[1.02] hover:border-[--primary] transition-all duration-300 cursor-pointer group border-2 border-transparent bg-blue-50 dark:bg-blue-950/20">
            <div className="aspect-video bg-gradient-to-br from-[--primary] to-[--primary-light] relative overflow-hidden group-hover:scale-105 transition-transform duration-300">
